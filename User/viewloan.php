            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="typeOfLoans.php">
                    <button class="btn btn-primary" style="margin-left:72%"><i class="fa fa-arrow-left"></i></button>
                </a>
                <button class="btn btn-success" data-toggle="modal" data-target="#add"><i class="fa fa-plus mr-2"></i>Add</button>
